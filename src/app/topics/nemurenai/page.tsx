...
const pageDescription =
  "眠れない背景には、気持ちの問題だけでなく、体の過緊張や交感神経の高ぶりが関わっていることが多い。血糖値を整えること、ボディワークで力を抜くこと、人との交流で感情を外に出すことから、眠れる状態に戻していく記録。";

export default function NemurenaiTopicPage() {
  const topic = readTopicDetail("nemurenai");
