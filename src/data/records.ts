...
export const records: RecordItem[] = [
  {
    ...
    text: "夢診断とホロスコープを使って、無意識にある抵抗感や違和感を読む話。就活への抵抗、内面を雑に扱われる環境、生活設計の見直しについて。",
  },
  {
    media: "stand.fm",
    ...
    text: "呼吸の速さ、首まわりの緊張、防衛反応が相手への安心感にどう伝わるか。身体を整えることと人間関係について。",
  },
  {
    media: "stand.fm",
    ...
    text: "人との相性や違和感を、その場のテンションではなく翌日の身体反応で見る話。記憶、呼吸、緊張、直感の扱いについて。",
  },
];
